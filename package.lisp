...
(defpackage :recursion-exercises
  ...
  (:export :fact :sum-list :double-list :largest-list :pos-list :merge-list
           ...
           :list-bigger :node :bt :make-node :node-p :node-value :node-right :node-left
           :search-bt :search-bst :path-ton :bt-path-ton :left :right :t
           :cons-to-end :follow-path :bt-ltor :combine-lists))
